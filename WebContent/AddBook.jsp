					...
					<form class="bs-example bs-example-form" role="form" action="AddBookServlet" method="post">
						...
						<dl class="form-group">
							...
							<dd>
								...
								pattern="^(\d{11}|\d{13})$" title="only numbers length is 11 or 13"
									oninvalid="setCustomValidity('only numbers length is 11 or 13')"
						...
						<dl class="form-group">
							...
							<dd>
								...
								class="form-control form-control-lg" placeholder="Please enter Author">
							</dd>
						</dl>
						<br>
						...
						<dl class="form-group">
							...
							<dd>
								<input type="number" name="Amount" id="Amount" required="required" 
									min="1" max="1000"
								class="form-control form-control-lg" placeholder="Please enter Amount">
							</dd>
						</dl>
						<br>
						<dl class="form-group">
