...
%>
        ...
        <BODY>
            <h1>图像测试</h1>
            <img id="book_thumb" class="img-thumbnail img-responsive book_thumb center-block" src="${pageContext.request.contextPath}/Files/<%=url %>"
                alt="图片无效">
            <div id="div_img">
                <img id="book_cover" class="book_cover hide_img" src="${pageContext.request.contextPath}/Files/<%=url %>" alt="图片无效">
            </div>
